...
- Workspace ID: `59893b0c-45d6-4310-813b-cb17075dd142`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/59893b0c-45d6-4310-813b-cb17075dd142.
...
2. `npx ngodingpakeai connect --workspace 59893b0c-45d6-4310-813b-cb17075dd142 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/59893b0c-45d6-4310-813b-cb17075dd142. Only pass on links the CLI actually printed — never assemble one from an id yourself.
