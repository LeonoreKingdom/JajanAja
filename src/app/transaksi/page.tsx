          ...
          <div className="w-full max-w-sm bg-white dark:bg-slate-850 border border-slate-100 dark:border-slate-700 rounded-3xl p-6 text-center shadow-2xl space-y-4">
            ...
            <div className="pt-2 flex items-center gap-2">
              <button
                ...
                className="flex-1 py-2.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 rounded-xl text-xs font-bold transition"
              >
                Tutup
              </button>
              <button
                type="button"
                onClick={() => router.push("/")}
                className="flex-1 py-2.5 bg-slate-900 hover:bg-slate-800 dark:bg-blue-600 dark:hover:bg-blue-700 text-white rounded-xl text-xs font-bold transition"
              >
                Ke Dashboard
              </button>
            </div>
