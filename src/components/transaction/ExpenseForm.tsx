  ...
  return (
    <div className="space-y-4">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="p-4 rounded-2xl bg-gradient-to-br from-rose-50/80 via-orange-50/40 to-amber-50/30 dark:from-rose-950/30 dark:via-orange-950/20 dark:to-amber-950/10 border border-rose-100 dark:border-rose-900/40 shadow-2xs">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-14 pr-4 py-3 bg-white dark:bg-slate-800 rounded-xl border border-rose-200/80 dark:border-rose-900/50 focus:outline-none focus:ring-2 focus:ring-rose-500 text-2xl sm:text-3xl font-black text-slate-900 dark:text-white tracking-tight shadow-xs"
              autoFocus
            />
          </div>
          ...
          <div className="flex items-center gap-1.5 mt-3 overflow-x-auto pb-1 no-scrollbar">
            {[10000, 20000, 50000, 100000, 250000].map((amt) => (
              <button
                ...
                className="px-2.5 py-1 bg-white dark:bg-slate-800 hover:bg-rose-50 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700 rounded-lg text-[11px] font-bold text-slate-700 dark:text-slate-300 whitespace-nowrap shadow-2xs transition active:scale-95"
              >
        ...
        <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-xs space-y-2.5">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-xs font-bold text-rose-600 hover:text-rose-700 dark:text-rose-400 dark:hover:text-rose-300 flex items-center gap-1 bg-rose-50 dark:bg-rose-950/50 px-2 py-0.5 rounded-md transition cursor-pointer"
            >
              <Plus size={13} />
            ...
            {customCategories.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`p-2.5 rounded-xl border text-left transition relative flex flex-col justify-between active:scale-95 cursor-pointer ${
                    isSelected
                ...
                >
                  ...
                  {/* Sisa Budget Tag */}
                  {budgetStatus && (
                    <div className="mt-2 pt-1.5 border-t border-slate-200/60 dark:border-slate-700 flex items-center justify-between text-[10px]">
                      <span className="text-slate-400 dark:text-slate-400">Sisa:</span>
                      <span
              ...
              return (
                <button
                  ...
                  className={`p-2.5 rounded-xl border text-left transition active:scale-95 ${
                    isSelected
                      ? "border-emerald-600 bg-emerald-50/80 dark:bg-emerald-950/40 text-emerald-950 dark:text-emerald-200 ring-1 ring-emerald-500"
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[9px] uppercase font-bold text-slate-400 dark:text-slate-300 bg-white dark:bg-slate-700 px-1 rounded border border-slate-200 dark:border-slate-600">
                      {ast.jenis}
                    </span>
                  </div>
        ...
        <div className="bg-white dark:bg-slate-900 p-4 rounded-2xl border border-slate-100 dark:border-slate-800 shadow-xs space-y-3">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 text-xs text-slate-800 dark:text-slate-200 font-semibold focus:outline-none focus:ring-1 focus:ring-rose-500"
              />
            </div>
            {errors.tanggal && (
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2.5 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 text-xs text-slate-800 dark:text-slate-200 placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-1 focus:ring-rose-500"
            />
          </div>
        ...
        <button
          ...
          className="w-full py-3.5 rounded-xl font-bold text-white text-sm flex items-center justify-center gap-2 bg-rose-600 hover:bg-rose-700 shadow-md shadow-rose-200 dark:shadow-none transition active:scale-[0.99] disabled:opacity-50 disabled:pointer-events-none cursor-pointer"
        >
          <Check size={18} />
          <span>
          ...
          <div className="w-full max-w-sm bg-white dark:bg-slate-900 rounded-2xl p-5 space-y-4 shadow-2xl border border-slate-100 dark:border-slate-800">
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
              ...
              <button
                ...
                className="w-7 h-7 rounded-full bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 cursor-pointer"
              >
                <X size={15} />
              </button>
            </div>
            ...
            <form onSubmit={handleAddCategorySubmit} className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-xs text-slate-800 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-1 focus:ring-rose-500"
                  autoFocus
                />
              </div>
