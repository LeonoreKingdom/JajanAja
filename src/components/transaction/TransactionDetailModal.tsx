        ...
        <div className="p-5 space-y-4 overflow-y-auto">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold text-slate-800 flex items-center gap-1">
                {transaction.sumber === "whatsapp" && (
                  <span className="inline-flex items-center gap-1 text-emerald-700 font-bold bg-emerald-50 px-1.5 py-0.2 rounded text-[10px] border border-emerald-200">
                    <MessageSquare size={10} />
                    WhatsApp
                  </span>
                )}
                {transaction.sumber === "pindai-struk" && (
                  <span className="inline-flex items-center gap-1 text-indigo-700 font-bold bg-indigo-50 px-1.5 py-0.2 rounded text-[10px] border border-indigo-200">
                    <Camera size={10} />
                    Pindai Struk AI
                  </span>
                )}
          ...
          <div className="grid grid-cols-2 gap-2 pt-1">
            <button
              ...
              className="py-2.5 px-3 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 transition active:scale-95"
            >
              {copied ? (
                <>
            ...
            {isExpense && onSplitBill ? (
              <button
                ...
                className="py-2.5 px-3 bg-amber-50 hover:bg-amber-100 text-amber-800 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 transition active:scale-95 border border-amber-200"
              >
                <Users size={14} />
              ...
              <button
                type="button"
                onClick={onClose}
                className="py-2.5 px-3 bg-slate-900 text-white rounded-xl text-xs font-bold hover:bg-slate-800 transition active:scale-95"
              >
                Selesai
              </button>
            )}
          ...
          {onDelete && (
            <div className="pt-2 border-t border-slate-100">
              {confirmDelete ? (
                <div className="p-3 bg-rose-50 rounded-xl border border-rose-200 text-center space-y-2 animate-in fade-in">
                  ...
                  <div className="flex items-center gap-2 pt-1">
                    <button
                      ...
                      className="flex-1 py-1.5 bg-white text-slate-700 text-xs font-bold rounded-lg border"
                    >
                      Batal
                    </button>
                    <button
                ...
                <button
                  ...
                  className="w-full py-2 text-rose-600 hover:text-rose-700 text-xs font-bold flex items-center justify-center gap-1.5 transition"
                >
                  <Trash2 size={13} />
