    ...
    <div className="bg-white rounded-2xl p-4 border border-slate-100 shadow-xs space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2 text-xs">
        <div className="p-2.5 rounded-xl bg-emerald-50/60 border border-emerald-100">
          ...
          <p className="font-black text-emerald-950 text-xs sm:text-sm mt-0.5">
        ...
        <div className="p-2.5 rounded-xl bg-rose-50/60 border border-rose-100">
          ...
          <p className="font-black text-rose-950 text-xs sm:text-sm mt-0.5">
        ...
        <div className="p-3 rounded-xl bg-slate-50 border border-slate-200/80 space-y-2">
          <div className="flex items-center justify-between text-xs">
            <span className="font-bold text-slate-700 flex items-center gap-1">
              ...
              {isOverBudget ? (
                <span className="text-rose-600 font-extrabold flex items-center gap-0.5 text-[10px]">
          ...
          <div className="flex items-center justify-between text-[10px] text-slate-400">
            <span>
              Sisa kuota pos:{" "}
              <strong className={isOverBudget ? "text-rose-600" : "text-slate-700"}>
