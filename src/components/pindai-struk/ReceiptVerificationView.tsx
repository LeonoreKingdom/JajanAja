    ...
    <div className="w-full space-y-4 animate-in fade-in pb-8">
      ...
      {isCancelConfirmOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-in fade-in">
          <div className="w-full max-w-xs bg-white dark:bg-slate-900 rounded-3xl p-5 space-y-4 shadow-2xl border border-slate-100 dark:border-slate-800 text-center">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl p-3 border border-slate-200 dark:border-slate-800 shadow-2xs flex items-center justify-between gap-3 transition-colors">
        <div className="flex items-center gap-2.5">
          {scanResult.fotoUrl && (
            <button
              type="button"
              onClick={() => setIsPhotoExpanded((prev) => !prev)}
              className="w-12 h-12 rounded-xl bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-600 overflow-hidden shrink-0 hover:ring-2 hover:ring-blue-400 transition"
      ...
      {isPhotoExpanded && scanResult.fotoUrl && (
        ...
        >
          <div className="max-w-sm max-h-[85vh] bg-white dark:bg-slate-900 rounded-3xl p-3 shadow-2xl border border-slate-100 dark:border-slate-800 relative overflow-hidden">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src={scanResult.fotoUrl}
              alt="Foto Struk Asli"
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl p-4 border border-slate-200 dark:border-slate-800 shadow-2xs space-y-3 transition-colors">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {/* Kategori Pos */}
        <div className="bg-white dark:bg-slate-900 rounded-2xl p-3.5 border border-slate-200 dark:border-slate-800 shadow-2xs space-y-1.5 transition-colors">
          <div className="flex items-center justify-between">
          ...
          <select
            ...
            className="w-full p-2 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-600 text-xs font-bold text-slate-800 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500"
          >
